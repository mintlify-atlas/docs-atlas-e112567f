...
<ResponseField name="course" type="object" required>
  ...
  <Expandable title="Course properties">
    ...
    <ResponseField name="sourceFiles" type="string[]">
      Array of Source document IDs (MongoDB ObjectIds) for the processed YouTube videos. Each entry references a Source document containing the transcript chunks and embeddings.
    </ResponseField>
